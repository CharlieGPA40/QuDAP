def NV_Read(MyField, myTemp, csv_filename, current):
    ...
    measurement_duration = 4  # seconds
    ...
    while time.time() - start_time < measurement_duration:
        ...
        # keithley_2182A_NV.write("SENS:CHAN 1")
        Chan_1_voltage = float(keithley_2182A_NV.query("FETCH?"))  # Read the measurement result
        # keithley_2182A_NV.write("SENS:FUNC:VOLT:DC")  # Configure to measure DC voltage
