...
# ===================== Complete BNC845SettingsWidget =====================
class BNC845SettingsWidget(QWidget):
    def __init__(self, parent=None):
        super().__init__()
        try:
    ...
    def set_instrument(self, instrument, demo_mode=False):
        ...
        self.bnc_instrument = instrument
    ...
    def set_controls_enabled(self, enabled):
        ...
        # Combo boxes
        self.bnc845rf_loop_setting_combo.setEnabled(enabled)
        self.bnc845rf_modulation_combo.setEnabled(enabled)
...
# ===================== Complete DSP7265SettingsWidget =====================
...
class SettingsTab(QWidget):
    ...
    def configure_fmr_measurement(self):
        ...
        # DSP7265 Settings
        self.dsp7265_settings_widget = DSP7265SettingsWidget()
        self.setting_layout.addWidget(self.dsp7265_settings_widget)

        # BNC845 Settings
        self.bnc845_settings_widget = BNC845SettingsWidget()
        self.setting_layout.addWidget(self.bnc845_settings_widget)
        ...
        self.config_layout.addLayout(self.setting_layout)
