...
# ===================== DSP7265 Settings Widget =====================
# class DSP7265SettingsWidget(QWidget):
#     """Complete DSP7265 configuration widget matching your original code"""
#
#     def __init__(self, parent=None):
#         super().__init__(parent)
#         self.font = QFont("Arial", 10)
...
#
#         # Left side - Settings
#         settings_group = QGroupBox("DSP 7265 Setting")
...
#
#         # VMODE container (will be populated dynamically)
...
#             ["Select Input Mode", "10 µs", "20 µs", "40 µs", "80 µs", "160 µs", "320 µs", "640 µs", "5 ms", "10 ms",
...
#
#         # # Right side - Readings (will be updated in real-time)
#         # readings_group = QGroupBox("DSP 7265 Reading")
#         # readings_layout = QVBoxLayout()
#         #
#         # # X Reading
#         # x_layout = QHBoxLayout()
#         # x_layout.addWidget(QLabel("X:"))
#         # self.x_label = QLabel("N/A")
...
#         # self.y_label = QLabel("N/A")
#         # self.y_label.setFont(self.font)
...
#         # self.mag_label = QLabel("N/A")
#         # self.mag_label.setFont(self.font)
...
#         #
#         # # Frequency
#         # freq_reading_layout = QHBoxLayout()
#         # freq_reading_layout.addWidget(QLabel("Frequency:"))
#         # self.freq_reading_label = QLabel("N/A")
#         # self.freq_reading_label.setFont(self.font)
#         # freq_reading_layout.addWidget(self.freq_reading_label)
#         # freq_reading_layout.addStretch()
#         # readings_layout.addLayout(freq_reading_layout)
#         #
#         # # Amplitude
#         # amp_layout = QHBoxLayout()
#         # amp_layout.addWidget(QLabel("Amplitude:"))
#         # self.amp_label = QLabel("N/A")
#         # self.amp_label.setFont(self.font)
#         # amp_layout.addWidget(self.amp_label)
#         # amp_layout.addStretch()
#         # readings_layout.addLayout(amp_layout)
#         #
#         # # Sensitivity
#         # sens_reading_layout = QHBoxLayout()
#         # sens_reading_layout.addWidget(QLabel("Sensitivity:"))
#         # self.sens_reading_label = QLabel("N/A")
#         # self.sens_reading_label.setFont(self.font)
#         # sens_reading_layout.addWidget(self.sens_reading_label)
#         # sens_reading_layout.addStretch()
#         # readings_layout.addLayout(sens_reading_layout)
#         #
#         # # Time Constant
#         # tc_reading_layout = QHBoxLayout()
#         # tc_reading_layout.addWidget(QLabel("Time Constant:"))
#         # self.tc_reading_label = QLabel("N/A")
#         # self.tc_reading_label.setFont(self.font)
#         # tc_reading_layout.addWidget(self.tc_reading_label)
#         # tc_reading_layout.addStretch()
#         # readings_layout.addLayout(tc_reading_layout)
#         #
#         # # Reference
#         # ref_layout = QHBoxLayout()
#         # ref_layout.addWidget(QLabel("Reference:"))
#         # self.ref_label = QLabel("N/A")
#         # self.ref_label.setFont(self.font)
#         # ref_layout.addWidget(self.ref_label)
#         # ref_layout.addStretch()
#         # readings_layout.addLayout(ref_layout)
#
#         # readings_group.setLayout(readings_layout)
#         # readings_group.setFixedWidth(520)
#         # main_layout.addWidget(readings_group)
#
#         self.set_controls_enabled(False)
#
#         # Add to DSP7265SettingsWidget class:
#
...
#
#         # Update style to show disabled state
#         if enabled:
#             self.imode_combo.setStyleSheet("")
#         else:
#             self.imode_combo.setStyleSheet("QComboBox { background-color: #f0f0f0; }")
#
...
#             ref_map = {0: 1, 1: 2, 2: 3}  # Map to combo index
#             if ref in ref_map:
...
#                 self.tc_combo.setCurrentIndex(tc_idx + 1)  # +1 for "Select Input Mode"
#
#             # Read and set sensitivity
#             sen_idx = int(self.dsp_instrument.query("SEN"))
#             if 0 <= sen_idx < self.sens_combo.count() - 1:
#                 self.sens_combo.setCurrentIndex(sen_idx + 1)  # +1 for "Select Sensitivity"
#
...
#             if 0 <= imode_idx < self.imode_combo.count() - 1:
#                 self.imode_combo.setCurrentIndex(imode_idx + 1)
#
#             # Read and set vmode
#             vmode_idx = int(self.dsp_instrument.query("VMODE[.]"))
#             if 0 <= vmode_idx < self.vmode_combo.count() - 1:
...
#
#     # All the control methods from your original code
...
#                 self.dsp_instrument.write('IMODE 0')
#             self.show_vmode_controls()
#         elif imode_idx == 2:
#             if self.dsp_instrument and not self.demo_mode:
#                 self.dsp_instrument.write('IMODE 1')
#             self.show_vmode_controls()
#         elif imode_idx == 3:
#             if self.dsp_instrument and not self.demo_mode:
#                 self.dsp_instrument.write('IMODE 2')
#
...
#         if self.dsp_instrument and not self.demo_mode and lf_n1_idx > 0:
#             if lf_n2_idx == 0:
...
#             QMessageBox.information(self, "Auto Sensitivity", "Auto sensitivity started")
#
...
#             QMessageBox.information(self, "Auto Phase", "Auto phase started")
#
#     def dsp7265_auto_meas(self):
#         if self.dsp_instrument and not self.demo_mode:
#             self.dsp_instrument.write('ASM')
#             QMessageBox.information(self, "Auto Measurement", "Auto measurement started")
#
#     def dsp7265_freq_setting(self):
#         freq = self.freq_entry.text()
#         if freq and self.dsp_instrument and not self.demo_mode:
...
#         if amplitude and self.dsp_instrument and not self.demo_mode:
#             self.dsp_instrument.write(f'OA. {float(amplitude)}')
#             time.sleep(1)
#             self.read_and_fill_sr7265_settings()
#         elif not amplitude:
#             QMessageBox.warning(self, 'Warning', 'Amplitude not set')
#
#     def clear_layout(self, layout):
#         if layout is None:
#             return
...
#     #     if self.demo_mode:
#     #         # Demo data
#     #         self.x_label.setText(f"{np.random.uniform(-1, 1):.6f} V")
#     #         self.y_label.setText(f"{np.random.uniform(-1, 1):.6f} V")
#     #         mag = np.random.uniform(0, 1)
#     #         self.mag_label.setText(f"{mag:.6f} V")
#     #         self.phase_label.setText(f"{np.random.uniform(-180, 180):.2f}°")
#     #     elif self.dsp_instrument:
#     #         try:
...
#     #
#     #             self.x_label.setText(f"{x:.6f} V")
#     #             self.y_label.setText(f"{y:.6f} V")
#     #             self.mag_label.setText(f"{mag:.6f} V")
#     #             self.phase_label.setText(f"{phase:.2f}°")
#     #         except Exception as e:
